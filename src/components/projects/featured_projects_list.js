...
const FeaturedProjectsList = [
    ...
    },
    {
        ...
        description: <Fragment><p className="is-size-4-desktop">I built this personal website primarly to replace the first iteration of my website which is a very simple HTML/CSS website. It was a great opportunity to get some new experience, so I decided to learn GatsbyJS, ReactJS and some Sass to build this website. I built all of the components myself, with the only outside packages coming from <a href="https://daneden.github.io/animate.css/" target="_blank" rel="noopener noreferrer">AnimateCSS</a> for some of the simple animations used. I used the <a href="https://bulma.io/" target="_blank" rel="noopener noreferrer">Bulma</a> CSS framework (no JavaScript included) for styling and <a href="https://pages.github.com/" target="_blank" rel="noopener noreferrer">GitHub Pages</a> for hosting.</p></Fragment>,
        image: <Fragment><figure className="image is-16by9"><img src={require('src/images/featured_projects/project3.png')} alt="Personal Website"/></figure></Fragment>,
