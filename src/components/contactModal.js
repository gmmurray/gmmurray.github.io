...
export default class ContactModal extends Component {
    ...
    submitForm = e => {
        ...
        Axios.post('https://mailthis.to/gregprofessional', this.state.values)
            .then(() => {
    ...
    addValidationMessages = () => {
        this.setState({
            errors: {
                name: !this.checkRequired(this.state.values.name) ? 'Please enter your name' : '',
                email: !this.checkEmail() ? 'Please enter a valid email' : '',
                message: !this.checkRequired(this.state.values.message) ? 'Please enter your message' : '',
            }
        });
    };

    validFields = () => {
        return this.checkEmail() && this.checkRequired(this.state.values.name) && this.checkRequired(this.state.values.email) && this.checkRequired(this.state.values.message);
    };
                            ...
                            <form onSubmit={this.submitForm}>
                                <div className="field is-horizontal">
                                    <div className="field-label is-normal">
                                        <label className="label font-yellow" htmlFor="name">Your name</label>
                                    </div>
                                ...
                                <div className="field is-horizontal">
                                    <div className="field-label is-normal">
                                        <label className="label font-yellow" htmlFor="email">Your email</label>
                                    </div>
                                    <div className="field-body">
                                        <div className="field">
                                            <p className="control">
                                ...
                                <div className="field is-horizontal">
                                    <div className="field-label is-normal">
                                        <label className="label font-yellow" htmlFor="message">Your message</label>
                                    </div>
                                    <div className="field-body">
                                        <div className="field">
                                            <p className="control">
